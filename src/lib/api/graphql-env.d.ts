...
export type introspection_types = {
    ...
    'ID': unknown;
    'Int': unknown;
    'Query': { kind: 'OBJECT'; name: 'Query'; fields: { 'tokenBalance': { name: 'tokenBalance'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; }; };
    'String': unknown;
    ...
    'TokenSubscription': { kind: 'OBJECT'; name: 'TokenSubscription'; fields: { 'tokenBalanceUpdates': { name: 'tokenBalanceUpdates'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'TokenBalanceUpdate'; ofType: null; }; } }; }; };
};
