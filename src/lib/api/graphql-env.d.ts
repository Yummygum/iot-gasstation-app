...
export type introspection_types = {
    ...
    'ID': unknown;
    'Int': unknown;
    'MutationRoot': { kind: 'OBJECT'; name: 'MutationRoot'; fields: { 'addClientToGroup': { name: 'addClientToGroup'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'GroupDto'; ofType: null; }; } }; 'createGroup': { name: 'createGroup'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'GroupDto'; ofType: null; }; } }; 'deleteGroup': { name: 'deleteGroup'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'UUID'; ofType: null; }; } }; 'registerClient': { name: 'registerClient'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'ClientDto'; ofType: null; }; } }; 'removeClient': { name: 'removeClient'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'UUID'; ofType: null; }; } }; 'removeClientFromGroup': { name: 'removeClientFromGroup'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'GroupDto'; ofType: null; }; } }; }; };
    'QueryRoot': { kind: 'OBJECT'; name: 'QueryRoot'; fields: { 'getClient': { name: 'getClient'; type: { kind: 'OBJECT'; name: 'ClientDto'; ofType: null; } }; 'getClientList': { name: 'getClientList'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'ClientDto'; ofType: null; }; }; }; } }; 'getGroup': { name: 'getGroup'; type: { kind: 'OBJECT'; name: 'GroupDto'; ofType: null; } }; 'getGroupList': { name: 'getGroupList'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'GroupDto'; ofType: null; }; }; }; } }; 'tokenBalance': { name: 'tokenBalance'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'SCALAR'; name: 'Int'; ofType: null; }; } }; }; };
    'String': unknown;
    'SubscriptionRoot': { kind: 'OBJECT'; name: 'SubscriptionRoot'; fields: { 'clientUpdates': { name: 'clientUpdates'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'ClientDto'; ofType: null; }; } }; 'groupUpdates': { name: 'groupUpdates'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'GroupDto'; ofType: null; }; } }; 'tokenBalanceUpdates': { name: 'tokenBalanceUpdates'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'TokenBalanceUpdate'; ofType: null; }; } }; }; };
