...
>(
  (
    ...
    const toggleSidebar = useCallback(() => {
      return isMobile
        ? setOpenMobile((openMobileCb) => !openMobileCb)
        : setOpen((openMobileCb) => !openMobileCb)
    ...
    return (
      <main
        className={cn(
          ...
          'md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-none md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2',
          className
        )}
        ref={ref}
        {...props}
